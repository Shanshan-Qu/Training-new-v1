# Step 14 — Capstone: Monthly Cost Report

_The "where did the money go this month?" lab._ 🏆 Builds the second team-owned artefact: the Monthly Cost Report. Combines Cost Management (Step 12), Blob Inventory (Step 08), and Workbooks (Step 11) into the canonical $-per-tier-per-account view leadership reads on the first business day of each month.
...
Render as Grid + Pie. Untagged rows show as "" — that's a tag-hygiene action item from Step 12.
...
4. Build an automation that emails the report PDF to the distribution group on the first of the month (Logic Apps, or a runbook in Step 15).
...
⬅️ **Previous:** [Step 13 — Capstone: Weekly Health Report](step-13-capstone-weekly-health.md)
➡️ **Next:** [Step 15 — Capstone: Incident Triage Tabletop](step-15-capstone-incident-triage.md)

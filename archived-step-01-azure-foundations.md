...
> **Prerequisites:** Your DIA-issued sandbox subscription is set up — see [Step 00 — Lab environment setup](step-00-lab-environment-setup.md). A modern browser. Your DIA work account.

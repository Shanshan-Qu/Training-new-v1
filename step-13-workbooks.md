# Step 13 — Azure Monitor Workbooks
...
> **Lab cost:** $0 — Workbooks are free, you reuse the workspace from Step 12.
> **Prerequisites:** Step 12 complete; the saved KQL functions you built there.
...
A Workbook is a sharable, parameterised report built from KQL queries. DSR uses one Workbook per concern — "DSR Health Daily", "ANL Storage Capacity", "Backup Compliance" — and a curated subset is pinned to dashboards. This lab walks you through authoring one from scratch, parameterising it (time range, environment dropdown), wiring tiles to the queries you saved in Step 12, and sharing it with your team.
...
2. Build a Workbook called **ANL Backup Daily** with three tiles: backup job count last 24h, failures last 24h, oldest restore point per protected resource. (Some queries return empty until you do Step 12; that's fine.)
...
⬅️ **Previous:** [Step 12 — Operational Visibility & Alerts](step-12-operational-visibility.md)
➡️ **Next:** [Step 14 — Cost Management for an application owner](step-14-cost-management.md)
